...
def analyze_google_results(state: State):
    ...
    try:
        ...
        print(f"analyze_google_results error: {e}")
        content = f"Error: {e}"
...
def analyze_bing_results(state: State):
    ...
    try:
        ...
        print(f"analyze_bing_results error: {e}")
        content = f"Error: {e}"
...
def analyze_reddit_results(state: State):
    ...
    try:
        ...
        print(f"analyze_reddit_results error: {e}")
        content = f"Error: {e}"
...
def synthesize_analyses(state: State):
    ...
    try:
        ...
        print(f"synthesize_analyses error: {e}")
...
def run_chatbot():
    ...
    while True:
        ...
        try:
            ...
            # Return the state with an error note so the loop continues
            final_state = state.copy()
            final_state["final_answer"] = f"Error during processing: {e}"
